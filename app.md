...
<video id="app_rendering_performance101" controls="" preload="none" poster="/assets/app_video/app_rendering_performance101.jpg">
      <source id="mp4" src="/assets/app_video/app_rendering_performance101.mp4" type="video/mp4">
...
<video id="app_understanding_overdraw" controls="" preload="none" poster="/assets/app_video/app_understanding_overdraw.jpg">
      <source id="mp4" src="/assets/app_video/app_understanding_overdraw.mp4" type="video/mp4">
      <p>Understanding Overdraw</p>
    </video>
...
<video id="app_understanding_vsync" controls="" preload="none" poster="/assets/app_video/app_understanding_vsync.jpg">
      <source id="mp4" src="/assets/app_video/app_understanding_vsync.mp4" type="video/mp4">
      <p>Understanding VSYNC</p>
    </video>
...
<video id="app_tool_profile_gpu_rendering" controls="" preload="none" poster="/assets/app_video/app_tool_profile_gpu_rendering.jpg">
      <source id="mp4" src="/assets/app_video/app_tool_profile_gpu_rendering.mp4" type="video/mp4">
      <p>Tool:Profile GPU Rendering</p>
    </video>
...
<video id="app_why60fps" controls="" preload="none" poster="/assets/app_video/app_why60fps.jpg">
      <source id="mp4" src="/assets/app_video/app_why60fps.mp4" type="video/mp4">
      <p>Why 60fps?</p>
    </video>
...
面，在下次需要渲染的时候直接进行操作。所以如果你更新了GPU所hold住的纹理内容，那么之前保存的状态就丢失了。
...
<video id="app_android_ui_and_the_gpu" controls="" preload="none" poster="/assets/app_video/app_android_ui_and_the_gpu.jpg">
      <source id="mp4" src="/assets/app_video/app_android_ui_and_the_gpu.mp4" type="video/mp4">
      <p>Android, UI and the GPU</p>
    </video>
...
<video id="app_invalidations_layouts_and_performance" controls="" preload="none" poster="/assets/app_video/app_invalidations_layouts_and_performance.jpg">
      <source id="mp4" src="/assets/app_video/app_invalidations_layouts_and_performance.mp4" type="video/mp4">
      <p>Invalidations, Layouts, and Performance</p>
    </video>
...
<video id="app_overdraw_cliprect_quickreject" controls="" preload="none" poster="/assets/app_video/app_overdraw_cliprect_quickreject.jpg">
      <source id="mp4" src="/assets/app_video/app_overdraw_cliprect_quickreject.mp4" type="video/mp4">
      <p>Overdraw, Cliprect, QuickReject</p>
    </video>
...
<video id="app_memory_churn_and_performance" controls="" preload="none" poster="/assets/app_video/app_memory_churn_and_performance.jpg">
      <source id="mp4" src="/assets/app_video/app_memory_churn_and_performance.mp4" type="video/mp4">
      <p>Memory Churn and performance</p>
    </video>
...
<video id="app_garbage_collection_in_android" controls="" preload="none" poster="/assets/app_video/app_garbage_collection_in_android.jpg">
      <source id="mp4" src="/assets/app_video/app_garbage_collection_in_android.mp4" type="video/mp4">
      <p>Garbage Collection in Android</p>
    </video>
...
<video id="app_performance_cost_of_memory_leaks" controls="" preload="none" poster="/assets/app_video/app_performance_cost_of_memory_leaks.jpg">
      <source id="mp4" src="/assets/app_video/app_performance_cost_of_memory_leaks.mp4" type="video/mp4">
      <p>Performance Cost of Memory Leaks</p>
    </video>
...
<video id="app_memory_performance101" controls="" preload="none" poster="/assets/app_video/app_memory_performance101.jpg">
      <source id="mp4" src="/assets/app_video/app_memory_performance101.mp4" type="video/mp4">
...
<video id="app_tool_memory_monitor" controls="" preload="none" poster="/assets/app_video/app_tool_memory_monitor.jpg">
      <source id="mp4" src="/assets/app_video/app_tool_memory_monitor.mp4" type="video/mp4">
      <p>Tool - Memory Monitor</p>
    </video>
...
<video id="app_battery_performance101" controls="" preload="none" poster="/assets/app_video/app_battery_performance101.jpg">
      <source id="mp4" src="/assets/app_video/app_battery_performance101.mp4" type="video/mp4">
...
<video id="app_understanding_battery_drain_on_android" controls="" preload="none" poster="/assets/app_video/app_understanding_battery_drain_on_android.jpg">
      <source id="mp4" src="/assets/app_video/app_understanding_battery_drain_on_android.mp4" type="video/mp4">
      <p>Understanding Battery Drain on Android</p>
    </video>
...
<video id="app_battery_drain_and_wakelocks" controls="" preload="none" poster="/assets/app_video/app_battery_drain_and_wakelocks.jpg">
      <source id="mp4" src="/assets/app_video/app_battery_drain_and_wakelocks.mp4" type="video/mp4">
      <p>Battery Drain and WakeLocks</p>
    </video>

From Youtube [Android Performance Patterns](http://goo.gl/3dBbse)
